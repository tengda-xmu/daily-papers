...
$task = New-ScheduledTask -Action $action -Trigger $trigger -Principal $principal -Settings $settings -Description 'Synchronize ResearchGate publication metadata before the 07:00 daily digest; browser session stays on this PC.'
