...
- 生成期间，回答区显示真实处理阶段、已用时间和最近一次响应时间；“处理记录”可查看提交、网络重试、生成等事件。这里只展示处理进度与面向读者的分析依据，不传递模型内部推理文本。接口事件依据 [Codex App Server 官方文档](https://learn.chatgpt.com/docs/app-server)。
