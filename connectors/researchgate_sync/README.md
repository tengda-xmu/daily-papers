...
The task `DailyPapers-ResearchGate` runs daily at 20:30 local time, before the
21:00 GitHub digest. The PC must be powered on and the Windows user signed in.
